...
依赖关系的复杂程度，已经上升到了完全不能靠人力手动解决的程度。
...
![images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img010.74e515e5.png)
...
![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img003.f9cc536c.png)
...
![images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img015.9ab3ebd3.png)
...
![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img010.7f3addf6.png)

##### [3]、使用命令生成Maven工程

![images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img008.be45c9ad.png)
...
POM：**P**roject **O**bject **M**odel，项目对象模型。和 POM 类似的是：DOM（Document Object Model），文档对象模型。
...
![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img011.621b1ac3.png)
...
![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img012.0bcc2c5d.png)
...
![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img013.8b57a581.png)
...
### d、创建 Maven 版的 Web 工程

#### (1)、说明

使用 mvn archetype:generate 命令生成 Web 工程时，需要使用一个专门的 archetype。这个专门生成 Web 工程骨架的 archetype 可以参照官网看到它的用法：

![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img014.942770a3.png)
...
![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img018.f836f056.png)

#### (8)、配置对 servlet-api.jar 包的依赖

对于不知道详细信息的依赖可以到https://mvnrepository.com/网站查询。使用关键词搜索，然后在搜索结果列表中选择适合的使用。

![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img019.46741083.png)
...
![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img024.91b00e04.png)
...
> TIP:[INFO] com.atguigu.maven:pro02-maven-web:war:1.0-SNAPSHOT
> [INFO] +- junit:junit:jar:4.12:test
> [INFO] | \- org.hamcrest:hamcrest-core:jar:1.3:test
> [INFO] +- javax.servlet:javax.servlet-api:jar:3.1.0:provided
> [INFO] \- com.atguigu.maven:pro01-maven-java:jar:1.0-SNAPSHOT:compile
...
![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img026.0ad36150.png)
...
![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img027.2faff879.png)
...
![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img037.53c95c38.jpg)
...
![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img029.48831f65.jpg)
...
![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img030.7f885903.png)

![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img032.9289c76e.png)
...
![images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img004.e823213d.png)
...
![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img033.39a65cee.png)

### c、创建 Java 模块工程

![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img034.dcd746ce.png)

![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img035.939da5d9.png)
...
![images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img006.969793b4.png)

另外，对于 IDEA 2018 诸版本没有自动生成 Web 设定，那么请参照下面两图，我们自己创建：

![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img042.32a9d794.png)

![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img043.0a913d5c.png)
...
![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img045.dd04540f.png)

#### (5)、设置 Web 资源的根目录

结合 Maven 的目录结构，Web 资源的根目录需要设置为 src/main/webapp 目录。

![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img046.71c20d43.png)
...
![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img040.ddaaa560.png)
...
![images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img029.7b9c7a12.png)
...
![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img041.c804be73.png)
...
![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img008.bb31d9a2.png)
...
![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img010.900e648d.png)

###### <4>、设置 Maven 核心程序位置

打开一个新的 Maven 工程，和新创建一个 Maven 工程是一样的，此时 IDEA 的 settings 配置中关于 Maven 仍然是默认值：

![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img011.d7914ffd.png)

所以我们还是需要像新建 Maven 工程那样，指定一下 Maven 核心程序位置：

![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img012.a62a48e8.png)
...
![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img013.5f438a0d.png)
...
![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img016.1933c568.png)
...
![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img019.772f07d3.png)

------

![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img020.bb620847.png)

------

![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img021.ac677293.png)

------

![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img022.ac55e275.png)

###### <5>、修改 pom.xml

刚刚导入的 module 的父工程坐标还是以前的，需要改成我们自己的 project。

![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img023.4ffa60b5.png)

------

![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img024.7585bfaa.png)

###### <6>、最终效果

![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img025.9e3d577f.png)

##### [3]、导入 Web 类型模块

其它操作和上面演示的都一样，只是多一步：删除多余的、不正确的 web.xml 设置。如下图所示：

![./images](https://ningct.oss-cn-hangzhou.aliyuncs.com/img026.8dad97d2.png)
...
| 工程名          | 地位   | 说明                                                |
| --------------- | ------ | --------------------------------------------------- |
| ssm-maven       | 父工程 | 总体管理各个子工程                                  |
| ssm-web         | 子工程 | 唯一的 war 包工程，依赖component                    |
| ssm-component   | 子工程 | 管理项目中的各种组件，依赖entity、util、environment |
| ssm-entity      | 子工程 | 管理项目中的实体类                                  |
| ssm-util        | 子工程 | 管理项目中的工具类                                  |
| ssm-environment | 子工程 | 框架环境所需依赖                                    |
| ssm-generate    | 子工程 | Mybatis 逆向工程                                    |
...
```xml
	...
	<dependency>
    	<groupId>org.example</groupId>
      	<artifactId>ssm-component</artifactId>
    	<version>1.0-SNAPSHOT</version>
	</dependency>
```
...
<!--2、依赖entity工程-->
	<dependency>
        <groupId>org.example</groupId>
        <artifactId>ssm-environment</artifactId>
        <version>1.0-SNAPSHOT</version>
    </dependency>
```
...
加入<scope>provided</scope>，只在本地测试使用，因为tomcat自带servletAPI
...
![image-20220710092021731](https://ningct.oss-cn-hangzhou.aliyuncs.com/image-20220710092021731.png)
...
```xml
 <!-- 4、javaBean的生成策略-->
        <javaModelGenerator targetPackage="ningct.ssm.entity" targetProject=".\src\main\java">
...
```xml
 <!-- 6、Mapper接口的生成策略 -->
        <javaClientGenerator type="XMLMAPPER" targetPackage="ningct.ssm.mapper"  targetProject=".\src\main\java">
            <property name="enableSubPackages" value="true" />
        </javaClientGenerator>
```
...
![image-20220710092928390](https://ningct.oss-cn-hangzhou.aliyuncs.com/image-20220710092928390.png)
...
![](https://ningct.oss-cn-hangzhou.aliyuncs.com/image-20220710093117492.png)

##### (2)、mapper接口

![image-20220710093243172](https://ningct.oss-cn-hangzhou.aliyuncs.com/image-20220710093243172.png)

##### (3)、mapper映射文件

![image-20220710093313705](https://ningct.oss-cn-hangzhou.aliyuncs.com/image-20220710093313705.png)

### ③、数据库连接

#### [1]、新建数据库连接信息资源文件

![image-20220710093510414](https://ningct.oss-cn-hangzhou.aliyuncs.com/image-20220710093510414.png)
...
![image-20220710093640681](https://ningct.oss-cn-hangzhou.aliyuncs.com/image-20220710093640681.png)
...
![image-20220710094101446](https://ningct.oss-cn-hangzhou.aliyuncs.com/image-20220710094101446.png)
...
在spring配置文件中整合，不需要创建mybatis的配置文件
...
```java
    ...
    public void testEmpMapper() {
        List<Department> depList = departmentMapper.selectByExample(new 
                                                                DepartmentExample());
...
事务搭建在service层，在component新建service包

![image-20220710095536979](https://ningct.oss-cn-hangzhou.aliyuncs.com/image-20220710095536979.png)
...
打开项目结构，若web模块未有web设定，点击+导入web

![image-20220710100231486](https://ningct.oss-cn-hangzhou.aliyuncs.com/image-20220710100231486.png)

#### [2]、修改web.xml位置

![image-20220710100310220](https://ningct.oss-cn-hangzhou.aliyuncs.com/image-20220710100310220.png)

#### [3]、修改资源根目录

![image-20220710100338820](https://ningct.oss-cn-hangzhou.aliyuncs.com/image-20220710100338820.png)

### ②、配置web.xml

#### [1]、加载 spring-persist.xml 
...
![image-20220710101041722](https://ningct.oss-cn-hangzhou.aliyuncs.com/image-20220710101041722.png)
...
![image-20220710101358509](https://ningct.oss-cn-hangzhou.aliyuncs.com/image-20220710101358509.png)

#### [4]、处理静态资源

将不经过渲染的静态资源交给默认servlet处理
...
![image-20220710101817683](https://ningct.oss-cn-hangzhou.aliyuncs.com/image-20220710101817683.png)

#### [2]、编写代码

```java
package ningct.ssm.exception;
...
![image-20220710102049818](https://ningct.oss-cn-hangzhou.aliyuncs.com/image-20220710102049818.png)

#### [2]、编写代码

```java
package ningct.ssm.util;

public class SsmConst {
    public static final String LOGIN_FAILED_MESSAGE = "账号、密码错误，不可进！";
    public static final String ACCESS_DENIED_MESSAGE = "禁地，不得擅入！";
...
![image-20220710101923840](https://ningct.oss-cn-hangzhou.aliyuncs.com/image-20220710101923840.png)
...
![image-20220710102157172](https://ningct.oss-cn-hangzhou.aliyuncs.com/image-20220710102157172.png)
...
<configuration debug="true">
    ...
    <!-- 专门给某一个包指定日志级别 -->
    <logger name="ningct" level="DEBUG" additivity="false">
        <appender-ref ref="STDOUT" />
    </logger>
