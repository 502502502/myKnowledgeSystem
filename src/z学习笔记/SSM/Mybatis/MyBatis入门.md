...
- ![MyBatis下载](https://ningct.oss-cn-hangzhou.aliyuncs.com/MyBatis%E4%B8%8B%E8%BD%BD.png)
## 4、和其它持久化层技术对比
- JDBC  
    ...
    <environments default="development">
        <environment id="development">
            ...
            <dataSource type="POOLED">
                ...
                <property name="username" value="ningct"/>
                <property name="password" value="ning502502502"/>
            </dataSource>
        </environment>
    </environments>
    <!--引入映射文件-->
    <mappers>
        <mapper resource="ningct/mybatis/mapper/UserMapper.xml"/>
    </mappers>
</configuration>
```
## 4、创建mapper接口
...
<mapper namespace="ningct.mybatis.mapper.UserMapper">
    <!--int insertUser();-->
...
<configuration>
    ...
    <typeAliases>
        ...
        <package name="ningct.mybatis.bean"/>
    </typeAliases>
    <!--
    ...
    <mappers>
        ...
        注意：
			...
			3.标签为package而不是mapper
        -->
        <package name="ningct.mybatis.mapper"/>
    </mappers>
</configuration>
```
**jdbc.properties**
...
![默认的类型别名1](https://ningct.oss-cn-hangzhou.aliyuncs.com/%E9%BB%98%E8%AE%A4%E7%9A%84%E7%B1%BB%E5%9E%8B%E5%88%AB%E5%90%8D1.png)
![默认的类型别名2](https://ningct.oss-cn-hangzhou.aliyuncs.com/%E9%BB%98%E8%AE%A4%E7%9A%84%E7%B1%BB%E5%9E%8B%E5%88%AB%E5%90%8D2.png)
	...
	```xml
	 <!--int updateUser();-->
       <update id="updateUser">
           update t_user set name = '张三' where id = 5
       </update>
	```
4. 查询一个实体类对象
	```xml
