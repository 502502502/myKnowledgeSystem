## 1、什么是[Nginx](https://so.csdn.net/so/search?q=Nginx&spm=1001.2101.3001.7020)？
...
rewrite功能时nginx服务器的基本功能之一，用于实现URL的重写，URL的重写是非常有用的功能，比如它可以在我们改变网站结构之后，不需要客户端修改原来的书签，也无需其他网站修改我们的链接，就可以设置为访问，另外还可以在一定程度上提高网站的安全性。
